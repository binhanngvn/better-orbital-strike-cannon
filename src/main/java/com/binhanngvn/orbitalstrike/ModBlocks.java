...
public class ModBlocks {
        ...
        return Registry.register(Registries.BLOCK, key, new TntBlock(AbstractBlock.Settings.create()
            ...
            public void onBlockAdded(BlockState state, World world, BlockPos pos, BlockState oldState, boolean notify) {
                if (!world.isClient() && world.isReceivingRedstonePower(pos)) {
                    primeTntX9((net.minecraft.server.world.ServerWorld) world, pos, 80);
    ...
    private static Block registerX18(String name) {
        ...
        return Registry.register(Registries.BLOCK, key, new TntBlock(AbstractBlock.Settings.create()
            ...
            public void onBlockAdded(BlockState state, World world, BlockPos pos, BlockState oldState, boolean notify) {
                if (!world.isClient() && world.isReceivingRedstonePower(pos)) {
                    primeTntX18((net.minecraft.server.world.ServerWorld) world, pos, 80);
                    world.removeBlock(pos, false);
                }
            }
    ...
    private static Block registerNukeClear(String name) {
        ...
        return Registry.register(Registries.BLOCK, key, new TntBlock(AbstractBlock.Settings.create()
            ...
            public void onBlockAdded(BlockState state, World world, BlockPos pos, BlockState oldState, boolean notify) {
                if (!world.isClient() && world.isReceivingRedstonePower(pos)) {
                    primeNukeClear((net.minecraft.server.world.ServerWorld) world, pos);
                }
            }
            ...
            @Override
            public void onExploded(BlockState state, net.minecraft.server.world.ServerWorld world, BlockPos pos, Explosion explosion, java.util.function.BiConsumer<net.minecraft.item.ItemStack, BlockPos> stackMerger) {
                primeNukeClear(world, pos);
            }
        });
    }

    private static void primeNukeClear(net.minecraft.server.world.ServerWorld world, BlockPos pos) {
        world.removeBlock(pos, false);
        ...
        new Thread(() -> {
            ...
            // 1. Spawn TNT bay lên (giữ nguyên hiệu ứng visual)
    ...
    private static void primeTntX9(net.minecraft.server.world.ServerWorld world, BlockPos pos, int baseFuse) {
        for (int i = 0; i < 9; i++) {
            TntEntity tnt = new TntEntity(world, pos.getX() + 0.5, pos.getY() + 0.5, pos.getZ() + 0.5, null);
    ...
    private static void primeTntX18(net.minecraft.server.world.ServerWorld world, BlockPos pos, int baseFuse) {
        for (int i = 0; i < 18; i++) {
            TntEntity tnt = new TntEntity(world, pos.getX() + 0.5, pos.getY() + 0.5, pos.getZ() + 0.5, null);
            tnt.setFuse(baseFuse + (i * 1));
